namespace Cars.Service.IntegrationTest.Controllers
{
    using System;
    ...
    public class CarsControllerTest : CustomWebApplicationFactory<Startup>
    {
        ...
        {
            this.CarRepositoryMock.Setup(x => x.GetAsync(999, It.IsAny<CancellationToken>())).ReturnsAsync(() => null);
        ...
        {
            this.CarRepositoryMock.Setup(x => x.GetAsync(1, It.IsAny<CancellationToken>())).ReturnsAsync(() => null);
