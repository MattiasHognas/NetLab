namespace Workspace.Service
{
    ...
    internal static class CustomServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Configures the settings by binding the workspaces of the appsettings.json file to the specified Plain Old CLR
        ...
        /// <summary>
        /// Add custom health check settings.
        /// </summary>
        /// <param name="services">The services.</param>
        ...
        /// <summary>
        /// Add custom api versioning settings.
        /// </summary>
        /// <param name="services">The services.</param>
        /// <returns>The services with custom api versioning services added.</returns>
